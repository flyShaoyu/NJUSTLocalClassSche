  ...
  <style>
    ...
    * {
    ...
    body {
      ...
      min-height: 100%;
      background:
        linear-gradient(180deg, #86b7eb 0, var(--sky) 176px, var(--paper) 176px, var(--paper) 100%);
      color: var(--ink);
    ...
    .content {
      padding: calc(10px + env(safe-area-inset-top)) 0 16px;
    }
    ...
    <main class="content">
      <div class="feature-shell">
        <section class="feature${firstImage ? "" : " empty"}">
          ...
          <div class="feature-caption">${firstImage ? firstImage.fileName : "校园风景图片占位"}</div>
        </section>
      </div>
